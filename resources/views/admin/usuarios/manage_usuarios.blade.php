...
@section('content')
    ...
    <div class="card  rounded-0 card-navy">
        <div class="card-header bg-gradient-navy text-white ">
            <h3 class="card-title">
    {{ isset($user) ? 'Actualizar Información del Usuario' : 'Crear Usuario' }}
</h3>
        ...
        <div class="card-body">
            <div class="container-fluid">
                ...
                <form action="" id="manage-user" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>{{ isset($user) ? 'Nueva ' : '' }}Contraseña</label>
        ...
        <div class="card-footer">
            <button class="btn btn-sm btn-primary" form="manage-user">Guardar Usuario</button>
            <a href="{{ route('admin.usuarios.index') }}" class="btn btn-sm btn-default border"><i
    ...
    $.ajax({
        ...
        success: function (resp) {
            if (resp.status === 'success') {                 
                location.href = "{{ route('admin.usuarios.index') }}";
            } else {
